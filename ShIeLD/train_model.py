...
graph-creation pipeline (e.g., Voronoi or random segmentation). It performs
...
- Graphs on disk:
    Expected directory structure under requirements["path_to_data_set"], encoding:
      ...
      * fussy limit (Voronoi) OR random_sampling folder (Random)
      * radius distance
    and inside that:
      train/graphs/
...
def main():
    ...
    for radius_distance, fussy_limit, anker_number in product(
        ...
        # For random: uses the random_sampling folder instead.
